...
public class GroovyShellService {
	...
	private Runnable threadInitCallback;
	...
	public Runnable getThreadInitCallback() {
		return threadInitCallback;
	}
	public void setThreadInitCallback(Runnable threadInitCallback) {
		this.threadInitCallback = threadInitCallback;
	}
	...
	protected SshServer buildSshServer() {
		...
		sshd.setShellFactory(new GroovyShellFactory(classLoader));
		return sshd;
	}
	...
	class GroovyShellFactory implements Factory<Command> {
		...
		public GroovyShellFactory(ClassLoader classLoader) {
			this.classLoader = classLoader;
		}
		...
		public Command create() {
			...
			return new GroovyShellCommand(classLoader, sshd, bindings, defaultScripts, threadFactory, threadInitCallback);
		}
	}
}
